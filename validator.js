...
function Validator(options) {
    ...
    if (formElement) {
        // Khi submit form, bỏ đi hành vi mặc định
        formElement.onsubmit = function (e) {
            ...
            if(isFormValid) {
                ...
                if(typeof options.onSubmit === 'function') {
                    // select tất cả field có attribute là name và ko có attribute là disabled
                    var enableInputs = formElement.querySelectorAll('[name]');
            
                    // convert enableInputs sang array để lấy các values
